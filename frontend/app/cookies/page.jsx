    ...
    <>
      ...
      <main className="legal-page">
        <article className="legal-page__inner">
          ...
          <section><h2>Qué utiliza Whaid</h2><h3>Tecnologías necesarias</h3><p>Permiten el funcionamiento técnico del sitio, protegen el formulario de demo contra abuso y recuerdan preferencias como el idioma, el tema visual y tu decisión sobre analítica. Están siempre activas porque no realizan seguimiento publicitario.</p><h3>Cookies de analítica</h3><p>Solo se habilitan si aceptas. Ayudan a comprender de manera agregada cómo se visita el sitio y a mejorar su contenido. Puedes rechazarlas sin perder acceso a Whaid.</p></section>
          <section><h2>Google Analytics</h2><p>Whaid tiene preparada una integración con Google Analytics 4 para analizar navegación y desempeño. La librería de Google no se descarga hasta que aceptas analítica y solo se utiliza cuando el sitio tiene configurado un identificador de medición.</p>
            <div className="legal-table-wrap"><table><thead><tr><th>Tecnología / cookie</th><th>Proveedor</th><th>Categoría</th><th>Finalidad</th><th>Duración aproximada</th></tr></thead><tbody>
              ...
              <tr><td>Cloudflare Turnstile</td><td>Cloudflare</td><td>Seguridad / funcional</td><td>Comprobar que las solicitudes del formulario no sean automatizadas. No depende del consentimiento de analítica.</td><td>Durante la verificación, según la configuración del proveedor.</td></tr>
