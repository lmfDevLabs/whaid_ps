...
<header className="hero">
  <div className="hero__inner">
    <div>
      <span className="hero__eyebrow" data-i18n="hero_eyebrow">Asistente IA sobre WhatsApp</span>
      <h1>
        <span data-i18n="hero_title_a">Conoce tus </span><span className="accent" data-i18n="hero_title_b">activos</span><span data-i18n="hero_title_c"> a un WhatsApp de distancia.</span>
      </h1>
      <p className="hero__lead" data-i18n="hero_sub">
        Whaid es el asistente conversacional que conecta tus sistemas y responde, en tiempo real, sobre el estado de tus inmuebles, empleados, productos, eventos y más — sin salir de WhatsApp.
      </p>
      ...
      <div className="hero__meta">
        ...
        <div className="hero__meta-item">
          ...
          <span className="hero__meta-v">ES · EN · PT<span className="dot">.</span></span>
        </div>
      </div>
    </div>
    ...
    <div className="wa-phone" aria-label="Demostración de conversación con Whaid en WhatsApp">
      ...
      <div className="web-panel" id="web-panel-hero" aria-hidden="true">
        ...
        <div className="web-panel__body">
          ...
          <div className="web-panel__kpis">
            <div className="web-panel__kpi"><span className="k">Activos</span><span className="v">84</span></div>
            <div className="web-panel__kpi"><span className="k">Alerta</span><span className="v warn">2</span></div>
            <div className="web-panel__kpi"><span className="k">ETA</span><span className="v">6m</span></div>
          </div>
          <div className="web-panel__list">
            <div className="web-panel__row warn">
              <span className="id">A-14</span>
              <span className="name" data-i18n="panel_row_a14">Stand · sin energía</span>
              <span className="badge">Alerta</span>
            </div>
            <div className="web-panel__row bad">
              <span className="id">B-04</span>
              <span className="name" data-i18n="panel_row_b04">Stand · POS offline</span>
              <span className="badge">Crítico</span>
            </div>
            <div className="web-panel__row ok">
              <span className="id">B-05</span>
              <span className="name" data-i18n="panel_row_b05">Stand · operando</span>
...
<section className="logos" aria-label="Clientes">
  <div className="container">
    <p className="logos__label">Operaciones que ya corren sobre Whaid</p>
    <div className="logos__row">
      <span>ExpoAndina</span>
      <span>Parque 93</span>
      <span>Unifronteras</span>
      <span>Ágora CC</span>
      <span>Bodega Norte</span>
      <span>Grupo Vértice</span>
    </div>
  </div>
</section>
...
<section className="section" id="keyshots">
  <div className="container">
    <div className="section__head reveal">
      ...
      <h2>
        <span data-i18n="keyshots_title_a">Pregúntale a tus datos </span><span className="accent" data-i18n="keyshots_title_b">como le escribes a un colega</span><span data-i18n="keyshots_title_c">.</span>
      </h2>
      <p data-i18n="keyshots_sub">Cuatro capacidades que convierten WhatsApp en tu panel operativo.</p>
    </div>
    ...
    <div className="keyshots">
      <article className="keyshot reveal">
        ...
        <h3 data-i18n="k1_title">Consulta en lenguaje natural</h3>
        <p data-i18n="k1_body">Pregunta en español por el estado de un activo, una venta, un evento o un arriendo. Whaid traduce tu pregunta a una consulta real.</p>
      </article>
      ...
      <article className="keyshot reveal">
        ...
        <h3 data-i18n="k2_title">Conectado a tus sistemas</h3>
        <p data-i18n="k2_body">Se integra con tus ERPs, hojas de cálculo, bases de datos y CRMs. La fuente de verdad sigue siendo tuya — Whaid solo traduce.</p>
      </article>
      ...
      <article className="keyshot reveal">
        ...
        <h3 data-i18n="k3_title">Alertas proactivas</h3>
        <p data-i18n="k3_body">Configura umbrales y disparadores. Whaid te escribe cuando algo requiere tu atención, antes de que lo tengas que buscar.</p>
      </article>
      ...
      <article className="keyshot reveal">
        ...
        <h3 data-i18n="k4_title">Permisos y auditoría</h3>
        <p data-i18n="k4_body">Cada conversación queda registrada. Define qué rol puede ver qué — la seguridad de tus datos es prioridad.</p>
      </article>
    </div>
  </div>
</section>
...
<section className="section section--alt" id="usecases">
  <div className="container">
    <div className="section__head reveal">
      ...
      <h2>
        <span data-i18n="usecases_title_a">Hecho para operaciones </span><span className="accent" data-i18n="usecases_title_b">complejas</span><span data-i18n="usecases_title_c">.</span>
      </h2>
      <p data-i18n="usecases_sub">Tres sectores donde la información sobre activos no puede esperar a un correo.</p>
    </div>
    ...
    <div className="usecases">
      ...
      <article className="usecase reveal">
        <div>
          ...
          <h3 data-i18n="uc1_title">Controla el piso de feria en tiempo real.</h3>
          <p data-i18n="uc1_body">Expositores, stands, asistencia y ventas del día consultables desde el celular del organizador. Sin tableros, sin logins extra.</p>
          ...
          <div className="usecase__stat">
            <span className="usecase__stat-num">43%</span>
            <span className="usecase__stat-txt" data-i18n="uc1_stat_a">menos tiempo resolviendo incidencias en piso</span>
          </div>
        </div>
        <div className="usecase__visual">
          <div className="uv-header">
            <span>Feria · Piso 2</span>
            <span>· En vivo</span>
          </div>
          <div className="uv-title">86 stands activos</div>
          <div className="uv-grid" style={{gridTemplateColumns: "repeat(4, 1fr)"}}>
            <div className="uv-cell"><span className="k">A-12</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">A-13</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">A-14</span><span className="v" style={{color: "#ff9c3f"}}>? <span className="dot" style={{background: "#ff9c3f"}}></span></span></div>
            <div className="uv-cell"><span className="k">A-15</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">B-01</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">B-02</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">B-03</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">B-04</span><span className="v" style={{color: "#ff6b6b"}}>OFF <span className="dot" style={{background: "#ff6b6b"}}></span></span></div>
            <div className="uv-cell"><span className="k">C-01</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">C-02</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">C-03</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
            <div className="uv-cell"><span className="k">C-04</span><span className="v">ON <span className="dot" style={{background: "#bdff00"}}></span></span></div>
          </div>
        </div>
      </article>
      ...
      <article className="usecase reveal">
        <div>
          ...
          <h3 data-i18n="uc2_title">La operación del CC a una conversación.</h3>
          <p data-i18n="uc2_body">Ocupación de locales, estado de contratos, mantenimientos abiertos, tráfico y KPIs por marca. Todo sobre WhatsApp, para gerencia y para comité.</p>
          <a href="/blog" className="learn-more"><span data-i18n="read_more">Leer más</span> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
          <div className="usecase__stat">
            <span className="usecase__stat-num">100%</span>
            <span className="usecase__stat-txt" data-i18n="uc2_stat_a">de indicadores unificados en un solo canal</span>
          </div>
        </div>
        <div className="usecase__visual">
          <div className="uv-header">
            <span>CC Parque 93 · hoy</span>
            <span>· 14:32</span>
          </div>
          <div className="uv-title">Resumen del día</div>
          <div className="uv-grid" style={{gridTemplateColumns: "1fr 1fr"}}>
            <div className="uv-cell" style={{padding: "16px"}}><span className="k">Ocupación locales</span><span className="v" style={{fontSize: "22px"}}>94<span style={{opacity: "0.5", fontSize: "16px"}}>%</span></span></div>
            <div className="uv-cell" style={{padding: "16px"}}><span className="k">Visitantes</span><span className="v" style={{fontSize: "22px"}}>12.4k</span></div>
            <div className="uv-cell" style={{padding: "16px"}}><span className="k">Ventas</span><span className="v" style={{fontSize: "22px"}}>$482M</span></div>
            <div className="uv-cell" style={{padding: "16px"}}><span className="k">Mantenim. abiertos</span><span className="v" style={{fontSize: "22px", color: "#ff9c3f"}}>7</span></div>
          </div>
        </div>
      </article>
      ...
      <article className="usecase reveal">
        <div>
          ...
          <p data-i18n="uc3_body">Aulas, laboratorios, inventarios, docentes, inscripciones. Whaid responde a decanaturas y administración con datos verificados.</p>
          <a href="/blog" className="learn-more"><span data-i18n="read_more">Leer más</span> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
          <div className="usecase__stat">
            <span className="usecase__stat-num">3×</span>
            <span className="usecase__stat-txt" data-i18n="uc3_stat_a">menos tickets a soporte por consultas de estado</span>
          </div>
        </div>
        <div className="usecase__visual">
          <div className="uv-header">
            <span>Universidad · Bloque A</span>
          ...
          <div className="uv-grid" style={{gridTemplateColumns: "repeat(3, 1fr)", gap: "8px"}}>
            <div className="uv-cell"><span className="k">A-101</span><span className="v">Lab Redes</span></div>
            <div className="uv-cell"><span className="k">A-102</span><span className="v">Aula 42p</span></div>
            <div className="uv-cell"><span className="k">A-103</span><span className="v" style={{color: "#ff9c3f"}}>Mant.</span></div>
            <div className="uv-cell"><span className="k">A-104</span><span className="v">Aula 60p</span></div>
            <div className="uv-cell"><span className="k">A-105</span><span className="v">Lab Física</span></div>
            <div className="uv-cell"><span className="k">A-106</span><span className="v">Aula 30p</span></div>
          </div>
        </div>
      </article>
    </div>
...
<section className="section" id="demo">
  <div className="demo reveal">
    <div className="demo__content">
      ...
      <h2 data-i18n="form_title">¿Listo para probar Whaid con tus datos?</h2>
      <p data-i18n="form_sub">Agenda una demo con nuestro equipo. Te conectamos a una fuente tuya y verás a Whaid responder en tu WhatsApp el mismo día.</p>
      <ul>
        ...
        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Demo sobre tu propia fuente de datos</li>
        <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg> Plan de activación claro al final de la llamada</li>
      </ul>
    </div>
...
<section className="section section--alt">
  <div className="container">
    <div className="section__head reveal">
      ...
      <p data-i18n="assets_sub">Whaid razona sobre los activos que mueven tu negocio. Y suma nuevos conectores cada mes.</p>
    </div>
  ...
  <div className="takelook__showcase">
    ...
    <div className="takelook__notes reveal">
      <div className="takelook__note">
        ...
        <p>El operador simplemente describe lo que necesita saber. Sin sintaxis, sin comandos.</p>
      </div>
      <div className="takelook__note">
        <div className="takelook__note-label">02 · Razonamiento</div>
        <h4>Consulta a la fuente real.</h4>
        <p>Whaid traduce la pregunta, verifica permisos y pregunta a tu ERP, CRM o base de datos en vivo.</p>
      </div>
      <div className="takelook__note">
        <div className="takelook__note-label">03 · Respuesta</div>
        <h4>Datos verificados, legibles, accionables.</h4>
        <p>La respuesta llega estructurada — con cifras, contexto y links al sistema original cuando hace falta.</p>
      </div>
      <div className="takelook__note">
        <div className="takelook__note-label">04 · Seguimiento</div>
        <h4>Puedes seguir preguntando.</h4>
        <p>Whaid mantiene el hilo de la conversación. No necesitas repetir el contexto.</p>
      </div>
    </div>
  </div>
</section>
