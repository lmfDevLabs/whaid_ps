...
const whatsappHref = `https://wa.me/${WHATSAPP_PHONE_NUMBER}?text=${encodeURIComponent(
  ...
  return (
    ...
    >
      <span className="whatsapp-floating-badge__copy">
        ...
        <span>Pregúntale directamente por WhatsApp.</span>
      </span>
      <span className="whatsapp-floating-badge__icon" aria-hidden="true">
