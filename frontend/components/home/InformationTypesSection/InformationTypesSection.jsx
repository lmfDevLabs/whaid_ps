      ...
      <section className="section section--alt">
        <div className="container">
          <div className="section__head reveal">
            <span className="eyebrow"><TranslatedText i18nKey="assets_eyebrow" /></span>
            <h2>
              <span><TranslatedText i18nKey="assets_title_a" /></span><span className="accent"><TranslatedText i18nKey="assets_title_b" /></span><span><TranslatedText i18nKey="assets_title_c" /></span>
            </h2>
            <p><TranslatedText i18nKey="assets_sub" /></p>
          </div>
          ...
          <div className="assets-carrousel reveal">
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a1" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a2" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a3" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a4" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a5" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a6" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a7" /></h3>
            ...
            <article className="asset-card">
              ...
              <div className="asset-card__footer">
                <h3><TranslatedText i18nKey="a8" /></h3>
            ...
            <aside className="asset-callout" aria-labelledby="asset-callout-label">
              ...
              <div className="asset-callout__content">
                <span id="asset-callout-label" className="asset-callout__label"><TranslatedText i18nKey="assets_callout_label" /></span>
                <p><TranslatedText i18nKey="assets_callout_body" /></p>
              </div>
            </aside>
          </div>
        </div>
