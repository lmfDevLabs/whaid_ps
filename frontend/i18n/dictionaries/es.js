const es = {
  ...
  "form_message": "¿Qué necesitas resolver con Whaid?",
  "form_submit": "Agendar demo",
  "form_disclaimer": "Usaremos tus datos solo para responder tu solicitud. El formulario está protegido contra abusos.",
  "form_benefit_time": "15 minutos de tu tiempo",
  "form_benefit_demo": "Conoce nuestro demo funcional",
  "form_benefit_plan": "Obtén un plan de activación claro para ti",
  "form_error_firstName": "Escribe un nombre de 2 a 60 caracteres.",
  "form_error_lastName": "Escribe un apellido de 2 a 60 caracteres.",
  "form_error_email": "Escribe un correo válido.",
  "form_error_company": "Escribe una empresa de 2 a 120 caracteres.",
  "form_error_phone": "El teléfono no puede superar 30 caracteres.",
  "form_error_message": "Escribe entre 10 y 2000 caracteres.",
  "form_status_validating": "Validando…",
  "form_status_sending": "Enviando…",
  "form_status_success": "Solicitud enviada",
  "form_status_error": "No pudimos enviar la solicitud. Tus datos se conservaron; inténtalo de nuevo.",
  "form_status_rateLimited": "Has realizado varios intentos. Espera unos minutos antes de volver a intentarlo.",
  "form_status_invalid": "Revisa los campos señalados.",
  "form_status_captcha": "Completa la verificación de seguridad.",
  "form_captcha_unavailable": "La verificación de seguridad no está disponible. Inténtalo de nuevo más tarde.",
  "form_captcha_failed": "No se pudo cargar la verificación de seguridad.",
